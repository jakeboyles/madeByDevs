					...
					<ul>
						...
						<li>
							<div class="score-head">
								<?php 
								$date = Date('m/d', strtotime($game['game_date_time']))
								?>
								<div class="match col-xs-7"><a href="<?php echo base_url('teams').'/page/'.$game['team_home_id']; ?>"><?php echo $game['home_team'];?></a> vs. <a href="<?php echo base_url('teams').'/page/'.$game['team_away_id']; ?>"><?php echo $game['away_team'];?></a></div>
								<div class="col-xs-5 text-right date-location"><span class="date"><?php echo $date;?></span></div>
